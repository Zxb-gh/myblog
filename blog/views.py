...
def detail(request, id):  # 查看文章详情
    ...
    return render(request, 'post.html',
                  {'post': post, 'nickname': request.session['nickname'], 'tags': tags, 'comment_list': comment_list,
                   'previouspost': previous_post, 'nextpost': next_post, 'avatar': request.session['avatar']})
...
def tag_detail(request, id):
    ...
    try:
        ...
        post_list = paginator.page(paginator.num_pages)
    return render(request, 'tags_detail.html',
                  {'post_list': post_list, 'tag': tag, 'nickname': request.session['nickname'],
                   'avatar': request.session['avatar']})
...
def category(request, id):
    ...
    return render(request, 'category.html',
                  {'post_list': post_list, 'nickname': nickname, 'avatar': request.session['avatar']})
